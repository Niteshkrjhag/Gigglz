...
fun GigPage7(
    ...
    Box(
        ...
        GradientButton(
            onClick = {navController.navigate(route = "GigPage7")},
            text = "Apply Now",
            modifier = Modifier
                .fillMaxWidth()
...
@Composable
fun PowerText(base: String, exponent: String, unit: String) {
    val screenWidth = LocalConfiguration.current.screenWidthDp

    val baseFontSize = (screenWidth * 0.05).sp  // Dynamic font size based on screen width
    val exponentFontSize = (screenWidth * 0.025).sp
    ...
    Text(
        text = buildAnnotatedString {
            withStyle(
                ...
                append(" ${getCurrencySymbol(Locale("hi", "IN"))}    ")
            }
            withStyle(
                style = SpanStyle(
                    fontSize = baseFontSize,
...
fun GradientButton(
    ...
    val buttonWidth = (screenWidth * 0.5).dp  // 50% of screen width
    val buttonHeight = (screenWidth * 0.13).dp  // Scaled height based on width
    val fontSize = (screenWidth * 0.06).sp  // Scaled text size
        ...
        modifier = modifier
            ...
            .background(
                brush = Brush.linearGradient(
                    colors = listOf(Color(0xFF0049A3), Color(0xFF1616B9))
                )
            )
